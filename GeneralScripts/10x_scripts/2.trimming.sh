...
# Trimming and filtering using Trimgalore! of the raw sequencing data of the 10x dlabrax
# This script is adapted from the ones of Nuria Sanchez Baizan (Ifremer)

src1="../../10x/raw_fastq_10x_subsampled"
outputdir1="../../10x/trimmed_10x"
...
output_file=""$report_dir"/trimming_summary_10x.1.txt"
