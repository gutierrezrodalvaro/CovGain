...
file_path = "/data2/gonzalo2/alvaro_data2/EMSeq_cov/5x/meth_extracted_5x/CpG_reports/"
file_list = list(
...
my_filtered_data <- filterByCombinedCpG(myobj, min.combined.cov = 10, hi.perc = 99.9)
