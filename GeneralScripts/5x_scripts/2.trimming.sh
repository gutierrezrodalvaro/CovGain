...
# Trimming and filtering using Trimgalore! of the raw sequencing data of the 5x dlabrax
# This script is adapted from the ones of Nuria Sanchez Baizan (Ifremer)

src1="../../5x/raw_fastq_5x_subsampled"
outputdir1="../../5x/trimmed_5x"
...
output_file=""$report_dir"/trimming_summary_5x.txt"
