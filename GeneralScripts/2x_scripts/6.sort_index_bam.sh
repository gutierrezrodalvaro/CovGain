...
# This script sorts and index the 2x deduplicated bam files using samtools

# Paths
PROJECT_ROOT="${EMSeq_cov:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)}"

SAMTOOLS="/opt/software/samtools-1.11/samtools"
INPUT_DIR="$PROJECT_ROOT/2x/deduplicated_2x"
OUTPUT_DIR="$PROJECT_ROOT/2x/dedup_sorted_indexed_2x"
