...
file_path = "/data2/gonzalo2/alvaro_data2/EMSeq_cov/2x/meth_extracted_2x/CpG_reports/"
file_list = list(
...
my_filtered_data <- filterByCombinedCpG(myobj, min.combined.cov = 10, hi.per=NULL)
