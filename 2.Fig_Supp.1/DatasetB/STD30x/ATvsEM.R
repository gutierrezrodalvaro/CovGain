...
# It uses de 30x datasets with the STD method
# Dataset B
...
normalized.myobj_STD30x=normalizeCoverage(filtered.myobj_STD30x, method = "median")
...
#  cat("Processing:", label, "\n")
  ...
  meth_tmp <- unite(normalized.myobj_STD30x,
                    destrand = TRUE,
